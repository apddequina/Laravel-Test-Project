...
<body class="bg-gray-100 min-h-screen p-6 flex justify-center items-center font-sans">
    ...
    <div class="bg-white shadow-2xl rounded-2xl p-10 max-w-2xl w-full">
        ...
        <form action="<?php echo e(route('store-ticket')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Support Ticket Project/support-ticket-app/resources/views/admin/ticket/ticket_form.blade.php ENDPATH**/ ?>